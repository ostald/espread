...
dir_con = readdir(joinpath(dir, "hist_deltaPitch_summed"))
...
for r in runs_xyz_10kev[5:9]
#for r in runs_xyz
    println(r)
    io = open(joinpath(dir, "hist_deltaPitch_summed", r), "r")
    ...
    lines!(ax, data/1e6, z_middle/1e3, label = "$(round(Int, E0/1000)) keV, $(round(Int, lim_pitch_deg))° ")
end
#for r in r1[1:4]
...
runs_xyz_deg = [
    "h_xyz_4000.0eV_66.0deg_summed.hist",
    "h_xyz_10000.0eV_66.0deg_summed.hist",
    "h_xyz_40000.0eV_66.0deg_summed.hist"
]
...
ax = Axis(f[1, 1], 
        ...
        xscale = log10,
        #xticks = LogTicks(-4:-2),
        title = "Pitch angle "*string(angle)* "°"
        )
